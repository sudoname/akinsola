...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ open: false }">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            @else
                                <a href="{{ route('register') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 mr-4">
                                    Register
                                </a>
                            @endif
                        </div>
            ...
            <!-- Page Content -->
            <div class="flex flex-col sm:justify-center items-center pt-6 sm:pt-10">
